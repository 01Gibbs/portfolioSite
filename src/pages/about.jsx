        ...
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              <h2 className="mb-4 text-lr font-bold uppercase text-dark/75 dark:text-light/75 ">
                Biography
              </h2>
            ...
            <div className="col-span-3 relative h-max rounded-2xl bg-light dark:bg-dark border-2 border-solid border-dark dark:border-light  p-8 xl:col-span-4 md:order-1 md:col-span-8">
              <Image
                src={profilePic}
                alt="Daniel Gilbert"
